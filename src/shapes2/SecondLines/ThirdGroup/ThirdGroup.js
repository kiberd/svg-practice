	...
	return (
		<>
			<g
				...
				transform="translate(1272.215 3853.948)"
			>
				<animated.path
					id="다각형_4-3"
					data-name="다각형 4"
                    ...
                    d="M5.5,0,11,14H0Z"
					transform="matrix(-0.469, 0.883, -0.883, -0.469, 116.732, 186.163)"
				...
				<animated.path
                    ...
                    d="M5.5,0,11,14H0Z"
					transform="translate(116.453 142.707) rotate(115)"
					fill={animationFillStyle.fillColor}
				/>
				<animated.path
					id="다각형_6-3"
                    ...
                    d="M5.5,0,11,14H0Z"
					transform="matrix(-0.309, 0.951, -0.951, -0.309, 116.284, 98.666)"
					fill={animationFillStyle.fillColor}
				/>
				<animated.path
					id="패스_10342"
                    ...
                    d="M5.5,0,11,14H0Z"
					transform="translate(115.379 55.187) rotate(109)"
					fill={animationFillStyle.fillColor}
				/>
				...
				<animated.path
					...
					d="M5661,3609.043s57.215,2.174,57.509,69.656,26.02,103.935,54.7,120.385"
					transform="translate(-5660.996 -3609.042)"
					fill="none"
					stroke="#1210c9"
				...
				<animated.path
					...
					d="M5661.634,3609.3s56.51,1.793,62.038,60.7,21.332,73.119,50.171,86.78"
					transform="translate(-5661.634 -3609.299)"
					fill="none"
					stroke="#1210c9"
				...
				<animated.path
					...
					d="M5661.5,3609.779s52.279,2.838,64.545,42.432,18.857,49.863,47.664,60.641"
					transform="translate(-5661.503 -3609.779)"
					fill="none"
					stroke="#1210c9"
				...
				<animated.path
					...
					d="M5661.595,3609.814s43.129,2.113,63.073,27.406,20.306,24.854,49.136,32.827"
					transform="translate(-5661.595 -3609.813)"
					fill="none"
					stroke="#1210c9"
...
export default React.memo(ThirdGroup);
